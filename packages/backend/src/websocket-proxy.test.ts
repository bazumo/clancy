...
describe('WebSocket Proxy Tests', () => {
  beforeAll(async () => {
    ...
    // Start proxy
    proxyHandle = await startProxy({ port: PROXY_PORT })
  }, 30000)
  ...
  describe('error handling', () => {
    ...
    // Skip: WSS error handling involves TLS handshake + upstream connection timeout
    // which is slow and unreliable in tests
    it.skip('should handle connection to non-existent server (wss://)', async () => {
